        ...
        >
          <div className="mb-24">
            ...
            <p className="font-body text-lg text-white/80 leading-relaxed mb-12 max-w-2xl">
              If you're a PE firm thinking about AI across your portfolio, or a
              company looking for senior product leadership — I'd like to hear
              from you.
            </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/20 text-sm font-body text-white/60 relative">
            <img
              src="https://cdn.magicpatterns.com/uploads/25xFanTHuf4KQ6Ksc2Ebiz/EPC_Final_logo_white.png"
